...
public class NumsOfDay {
    ...
    public static void main(String args[]) {
        ...
        do {
            monthInput = JOptionPane.showInputDialog(null, "Please enter month",
                    "Input the month",
        ...
        do {
            yearInput = JOptionPane.showInputDialog(null, "Please enter year",
                    "Input the year",
                    JOptionPane.INFORMATION_MESSAGE);
            // nhập không hợp lệ sẽ bắt nhập lại
        ...
        /*
         * Nếu là tháng 2
         * + năm nhuận trả về 29 và ngược lại trả về 28
         * Không phải là tháng 2 thì lấy số ngày từ mảng month
         */
        if (monthInput.equals("2")) {
            ...
            JOptionPane.showMessageDialog(null, "Nums of day: " +
                    month[monthOfYear - 1][month[monthOfYear - 1].length - 1]);
        }
