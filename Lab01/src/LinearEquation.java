...
public class LinearEquation {
    ...
    public static void firstDegreeEquation() {
        ...
        strNum1 = JOptionPane.showInputDialog(null, "20204939 - nctanh please input a: ",
                "Input the number",
                JOptionPane.INFORMATION_MESSAGE);
        strNum2 = JOptionPane.showInputDialog(null, "20204939 - nctanh please input b: ",
                "Input the number",
                JOptionPane.INFORMATION_MESSAGE);
        // convert to double
        ...
        if (a == 0)
             ...
             */
            if (b != 0)
                JOptionPane.showMessageDialog(null, "20204939 - nctanh - PT vo nghiem",
                        "ax + b = 0 ", JOptionPane.INFORMATION_MESSAGE);
            else
                JOptionPane.showMessageDialog(null, "20204939 - nctanh - PT vo so nghiem",
                        "ax + b = 0 ", JOptionPane.INFORMATION_MESSAGE);
        else
            // show result
            JOptionPane.showMessageDialog(null, "20204939 - nctanh - PT co nghiem x = " + (-b / a),
                    "ax + b = 0 ", JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void theSystemfirstDegreeEquation() {
        ...
        for (int j = 0; j < 2; j++) {
            // get num from keyboard
            num = JOptionPane.showInputDialog(null, "20204939 - nctanh Enter b" + (j + 1) + ":",
                    expression,
                    JOptionPane.INFORMATION_MESSAGE);
            // convert to double
        ...
        if (D == Dx && Dx == Dy && Dx == 0)
            JOptionPane.showMessageDialog(null, "20204939 - nctanh - Hệ có vô số nghiệm",
                    expression, JOptionPane.INFORMATION_MESSAGE);
        else if (D == 0 && (Dx != 0 || Dy != 0))
            JOptionPane.showMessageDialog(null, "20204939 - nctanh - Hệ  vô  nghiệm",
                    expression, JOptionPane.INFORMATION_MESSAGE);
        else {
            // x = Dx / D
            // y = Dy / D
    ...
    public static void seconDegreeEquation() {
        ...
        strNum2 = JOptionPane.showInputDialog(null, "20204939 - nctanh please input b: ",
                expression,
                JOptionPane.INFORMATION_MESSAGE);
        strNum3 = JOptionPane.showInputDialog(null, "20204939 - nctanh please input c: ",
                expression,
                JOptionPane.INFORMATION_MESSAGE);
        ...
        if (a == 0) {
            if (b == 0)
                if (c != 0)
                    JOptionPane.showMessageDialog(null, "20204939 - nctanh - PT vô nghiệm",
                            expression, JOptionPane.INFORMATION_MESSAGE);
                else
                    JOptionPane.showMessageDialog(null, "20204939 - nctanh - PT vô số nghiệm",
                            expression, JOptionPane.INFORMATION_MESSAGE);
            else
                // show result
                JOptionPane.showMessageDialog(null, "20204939 - nctanh - PT co nghiem x = " + (-c / b),
                        expression, JOptionPane.INFORMATION_MESSAGE);
        } else {
            /*
            ...
            if (delta < 0)
                ...
                JOptionPane.showMessageDialog(null,
                        "20204939 - nctanh - PT có 2 nghiệm phân biệt x1 = " + x1 + " x2 = " + x2,
                        expression, JOptionPane.INFORMATION_MESSAGE);
